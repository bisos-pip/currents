...
####+BEGIN: blee:bxPanel:foldingSection :outLevel 1 :title "Support Functions"  :extraInfo ""
""" #+begin_org
...
####+BEGIN: bx:icm:python:func :funcName "pkgBase_configDir" :funcType "anyOrNone" :retType "string" :deco "" :argsList "" :comment "Returns icmsPkg's config directory"
"""
*  [[elisp:(org-cycle)][| ]]  [[elisp:(org-show-subtree)][|=]] [[elisp:(show-children 10)][|V]] [[elisp:(org-tree-to-indirect-buffer)][|>]] [[elisp:(blee:ppmm:org-mode-toggle)][Nat]] [[elisp:(beginning-of-buffer)][Top]] [[elisp:(delete-other-windows)][(1)]] || Func-anyOrNone :: /pkgBase_configDir/ =Returns icmsPkg's config directory= retType=string argsList=nil  [[elisp:(org-cycle)][| ]]
"""
